...
public class SongsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // There should be a {@link ListView} with the view ID called listview_element, which is
        // declared in the songs_list.xml layout file.
        ListView listView = findViewById(R.id.listview_element);
